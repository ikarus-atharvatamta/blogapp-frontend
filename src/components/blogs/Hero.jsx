...
A 3D sofa configurator enhances the customer shopping experience by allowing them to create personalized furniture designs tailored to their specific needs, preferences, and space.  </h3>
       </div>   <button className="mt-10 bg-white text-[#CF462A] px-10 py-4 rounded font-medium  hover:bg-gray-200 cursor-pointer">Read more</button>
        </div>
        <div className='p-10 pl-30 hover:scale-105 ease-in-out duration-300 cursor-pointer'>
