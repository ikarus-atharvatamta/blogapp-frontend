    ...
    return (  
     ...
     <div>
        <div className='flex justify-center items-center  sm:px-6 lg: py-10'>
           <div className='hover:scale-105 ease-in-out duration-300 cursor-pointer'> <img src={imageplaceholder} alt="" /></div>
        ...
        <div className='ml-10 max-w-lg'>
           ...
           {/*button*/}
           <div><button className="mt-6 border border-red-400 text-[#CF462A] px-6 py-3 rounded-lg font-bold text-sm hover:bg-[#CF462A]/10 cursor-pointer">Read more</button></div>
        </div>
     </div>
     </div>
        </>
